      ...
      <div className="items-container">
        ...
        <VerticalTimeline>
          ...
          >
            ...
            <h4 className="vertical-timeline-element-subtitle">Year Up United - Seattle Central College</h4>
            <p>
            •	Oversaw guest management for up to 400+ guests during peak seasons and events, ensuring seamless operations and exceptional customer experiences.
            </p>
          </VerticalTimelineElement>
          <VerticalTimelineElement
            className="vertical-timeline-element--work"
          ...
          >
            ...
            <h4 className="vertical-timeline-element-subtitle">University of Washington</h4>
            <p>
          ...
          >
            ...
            <h4 className="vertical-timeline-element-subtitle">City of Bellevue (Bellevue Stream Team)</h4>
            <p>
          ...
          >
            ...
            <h4 className="vertical-timeline-element-subtitle">Entre Hermanos</h4>
            <p>
              Full-stack Development, API Development, User Experience
            </p>
          </VerticalTimelineElement>
          ...
          >
            ...
            <h4 className="vertical-timeline-element-subtitle">Bellevue College</h4>
            <p>
